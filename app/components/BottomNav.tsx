...
export default function BottomNav({
  ...
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-[#161618]/90 backdrop-blur-xl border-t border-[#232326] px-5 py-2.5 flex justify-between items-center z-50">
      <button
      ...
      >
        <div className="relative">
          ...
          {taskCountToday > 0 && (
            <span className="absolute -top-1.5 -right-2 bg-[#FF5E5E] text-white text-[9px] font-bold px-1 py-0.2 rounded-full">
              {taskCountToday}
            </span>
          )}
        </div>
      ...
      >
        <div className="relative">
          ...
          {taskCountInbox > 0 && (
            <span className="absolute -top-1.5 -right-2 bg-[#A78BFA] text-white text-[9px] font-bold px-1 py-0.2 rounded-full">
              {taskCountInbox}
            </span>
          )}
        </div>
