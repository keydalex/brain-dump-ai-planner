...
8. Якщо вказано "до другої справи" (наприклад "гуляю до залу о 18:00"), то тривалість нової справи вираховується ЯК ІНТЕРВАЛ ВІД ПОЧАТКУ ДО ВКАЗАНОГО ЧАСУ НАСТУПНОЇ СПРАВИ!`,
          },
        ],
      },
      generationConfig: {
