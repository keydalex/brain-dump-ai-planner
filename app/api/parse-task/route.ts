...
3. Витягуй проміжок часу у полі timeSlot (наприклад, "18:20-18:55" або "15:00-16:30"). Якщо час не вказано як інтервал, а лише як точний момент (наприклад, "о 18:00"), постав timeSlot: "18:00".
