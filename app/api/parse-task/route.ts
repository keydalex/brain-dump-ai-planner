...
7. Зауваж: Завершено/закреслені справи (status = 'done') НЕ вважаються конфліктом часу й НЕ заважають плануванню!
...
2. <raw_data_input>зустріч у вівторок о 16:00 через 2 години</raw_data_input> -> priority: 1, category: "work", duration: 60, dueDate: "${todayStr}", timeSlot: "16:00 - 17:00"
3. <raw_data_input>тренування через 2 дні в суботу вранці</raw_data_input> -> priority: 2, category: "fitness", duration: 60, dueDate: "${todayStr}", timeSlot: "09:00 - 10:00"`,
          },
        ],
      },
      generationConfig: {
